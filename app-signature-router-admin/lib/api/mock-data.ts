...
export const mockProvidersData = [
  {
    id: 'prov-twilio-sms-001',
    provider_name: 'Twilio SMS Primary',
    provider_type: 'SMS',
    enabled: true,
    priority: 1,
  ...
  {
    id: 'prov-firebase-fcm-001',
    provider_name: 'Firebase Cloud Messaging',
    provider_type: 'PUSH',
    enabled: true,
    priority: 1,
    endpoint_url: 'https://fcm.googleapis.com/v1/projects/singular-bank/messages:send',
    authentication_type: 'BEARER_TOKEN',
    configuration: {
      server_key_masked: 'AAAA***************',
      project_id: 'singular-bank',
      max_retries: 2,
      timeout_seconds: 20,
    },
    health_status: 'UP',
    last_health_check: new Date(Date.now() - 1 * 60 * 1000).toISOString(),
    circuit_breaker_status: 'CLOSED',
    created_at: '2025-11-05T11:00:00Z',
    created_by: 'admin@bank.com',
    updated_at: '2025-11-28T16:20:00Z',
    updated_by: 'operator@bank.com',
  },
  {
    id: 'prov-vonage-voice-001',
    provider_name: 'Vonage Voice API',
    provider_type: 'VOICE',
    enabled: true,
    priority: 1,
    endpoint_url: 'https://api.nexmo.com/v1/calls',
    authentication_type: 'API_KEY',
    configuration: {
      api_key: 'vnge***************',
      api_secret_masked: '********************************',
      from_number: '+34987654321',
      max_retries: 2,
      timeout_seconds: 45,
    },
  ...
  {
    id: 'prov-biocatch-001',
    provider_name: 'BioCatch Biometric Auth',
    provider_type: 'BIOMETRIC',
    enabled: false,
    priority: 2,
    endpoint_url: 'https://api.biocatch.com/v2/verify',
    authentication_type: 'OAUTH2',
    configuration: {
      client_id: 'bc***************',
      client_secret_masked: '********************************',
      oauth_token_url: 'https://auth.biocatch.com/oauth/token',
      max_retries: 1,
      timeout_seconds: 60,
    },
    health_status: 'DOWN',
    last_health_check: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
