...
Write-Host "`n📊 Verificando versiones..." -ForegroundColor Cyan
...
try {
    ...
    Write-Host "   ❌ Maven no disponible en PATH" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "   ⚠️  Docker no disponible (opcional)" -ForegroundColor Yellow
}

Write-Host "`n✅ Entorno configurado para Signature Router" -ForegroundColor Green
