 ...
 *     instances:
 *       smsRetry:
 *         retry-on-exception-predicate: com.bank.signature.infrastructure.resilience.RetryExceptionPredicate
 * }</pre>
 * 
...
public class RetryExceptionPredicate implements Predicate<Throwable> {
    ...
    public boolean test(Throwable throwable) {
        ...
        if (throwable.getClass().getPackageName().startsWith("com.bank.signature.domain.exception")) {
