...
public class RoutingServiceImpl implements RoutingService {
    ...
    public RoutingDecision evaluate(TransactionContext transactionContext) {
        ...
        SimpleEvaluationContext context = createEvaluationContext(transactionContext);
    ...
    /**
     * Creates a secure evaluation context with transaction data.
     * Uses SimpleEvaluationContext (no reflection, T(), etc.)
     * 
     * @param transactionContext Transaction context with available variables
     * @return SimpleEvaluationContext ready for SpEL evaluation
     */
    private SimpleEvaluationContext createEvaluationContext(TransactionContext transactionContext) {
        // Build context map with transaction data
        Map<String, Object> amount = new HashMap<>();
        amount.put("value", transactionContext.amount().amount());
        amount.put("currency", transactionContext.amount().currency());
        
        Map<String, Object> context = new HashMap<>();
        context.put("amount", amount);
        context.put("merchantId", transactionContext.merchantId());
        context.put("orderId", transactionContext.orderId());
