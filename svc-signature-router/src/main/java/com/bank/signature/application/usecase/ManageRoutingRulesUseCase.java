...
public interface ManageRoutingRulesUseCase {
     ...
     * @throws com.bank.signature.domain.exception.InvalidSpelExpressionException if
     *                                                                            SpEL
     *                                                                            invalid
     */
     ...
     * @throws com.bank.signature.domain.exception.NotFoundException              if
     *                                                                            rule
     *                                                                            not
     *                                                                            found
     * @throws com.bank.signature.domain.exception.InvalidSpelExpressionException if
     ...
     * @throws com.bank.signature.domain.exception.NotFoundException if rule not
     *                                                               found
     */
