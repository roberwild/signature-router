...
public class GetDashboardMetricsUseCaseImpl implements GetDashboardMetricsUseCase {
    ...
    public DashboardMetricsResponse execute() {
        ...
        // Overview metrics (now includes activeSignatures, routingRulesCount, circuitBreakersOpen, failedSignatures24h)
        ...
        log.info("Dashboard metrics computed: total24h={}, successRate={}, activeProviders={}/{}, activeSignatures={}, rules={}, cbOpen={}",
    ...
    private List<ProviderHealthStatus> computeProviderHealth() {
        ...
        for (ProviderHealthResponse provider : healthResponse.providers()) {
            ...
            double uptime = status.equals("healthy") ? 99.9 : 
                           status.equals("degraded") ? 95.0 : 0.0;
