...
import com.bank.signature.application.usecase.GetDashboardMetricsUseCase;
 ...
 * - Overview statistics (total signatures, success rate, latency, active providers)
        ...
        @ApiResponse(
            ...
            content = @Content(
                ...
                examples = @ExampleObject(
                    name = "Dashboard Metrics Example",
                    summary = "Typical dashboard metrics response",
                    value = """
                        {
                          "overview": {
