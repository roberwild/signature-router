...
import com.bank.signature.domain.exception.AccessDeniedException;
...
public class CustomerOwnershipAspect {
     ...
     */
    @AfterReturning(
        pointcut = "execution(* com.bank.signature.application.usecase.QuerySignatureUseCase.execute(..))",
