package com.bank.signature.infrastructure.aspect;
...
public class AuditAspect {
    ...
    @Pointcut("@annotation(org.springframework.web.bind.annotation.PostMapping) && " +
              "execution(* com.bank.signature.infrastructure.adapter.inbound.rest..*Controller.create*(..))")
    ...
    @Pointcut("@annotation(org.springframework.web.bind.annotation.PutMapping) && " +
              "execution(* com.bank.signature.infrastructure.adapter.inbound.rest..*Controller.update*(..))")
    ...
    @Pointcut("@annotation(org.springframework.web.bind.annotation.PatchMapping) && " +
              "execution(* com.bank.signature.infrastructure.adapter.inbound.rest..*Controller.*(..))")
    ...
    @Pointcut("@annotation(org.springframework.web.bind.annotation.DeleteMapping) && " +
              "execution(* com.bank.signature.infrastructure.adapter.inbound.rest..*Controller.delete*(..))")
