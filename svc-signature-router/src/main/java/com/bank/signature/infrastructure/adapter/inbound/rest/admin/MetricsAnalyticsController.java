...
public class MetricsAnalyticsController {
    ...
    @Operation(
        summary = "Get advanced metrics analytics",
        description = """
    ...
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
            description = "Metrics analytics retrieved successfully",
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = MetricsAnalyticsResponse.class),
                examples = @ExampleObject(
                    name = "Metrics Analytics Example",
                    summary = "7 days metrics with no channel filter",
                    value = """
                        {
                          "range": "7d",
                          "latency": {
    ...
    public ResponseEntity<MetricsAnalyticsResponse> getMetricsAnalytics(
        @Parameter(
            ...
            example = "7d",
            schema = @Schema(allowableValues = {"1d", "7d", "30d"})
        )
