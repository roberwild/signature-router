...
public class SLOReportService {
    ...
    public String generateMarkdown(SLOReportDTO report) {
        ...
        md.append("# 📊 SLO Compliance Report\n\n");
        ...
        md.append("## 🎯 Availability SLO (Target: ≥99.9%)\n\n");
        ...
        String availabilityStatus = report.getAvailability() >= 0.999 ? "✅ **PASSING**" : "❌ **FAILING**";
        md.append(String.format("**Result:** %s\n\n", availabilityStatus));
        
        // Error Budget Section
        md.append("---\n\n");
        md.append("## 💰 Error Budget\n\n");
        ...
        md.append(String.format("- **Budget Remaining:** %.4f%% (%s)\n",
            ...
            report.getErrorBudgetRemaining() >= 0 ? "✅" : "❌ EXHAUSTED"
        ));
        ...
        md.append("---\n\n");
        md.append("## ⚡ Performance SLO (Target: P99 < 300ms)\n\n");
        md.append(String.format("- **P99 Latency:** %.0fms\n", report.getP99Latency() * 1000));
        md.append(String.format("- **Target:** <300ms\n\n"));
        
        String performanceStatus = report.getPerformanceSloMet() ? "✅ **PASSING**" : "❌ **FAILING**";
        md.append(String.format("**Result:** %s\n\n", performanceStatus));
     ...
     */
    private String getStatusEmoji(com.bank.signature.domain.model.valueobject.SLOStatus status) {
        switch (status) {
            case COMPLIANT:
                return "✅ COMPLIANT";
            case AT_RISK:
