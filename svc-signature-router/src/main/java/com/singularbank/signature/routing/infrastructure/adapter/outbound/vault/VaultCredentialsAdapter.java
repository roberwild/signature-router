package com.singularbank.signature.routing.infrastructure.adapter.outbound.vault;

import com.singularbank.signature.routing.domain.exception.VaultException;
