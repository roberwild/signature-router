...
import com.singularbank.signature.routing.domain.exception.ChallengeNotBelongsException;
import com.singularbank.signature.routing.domain.exception.InvalidStateTransitionException;
import com.singularbank.signature.routing.domain.exception.TtlNotExceededException;
...
public class SignatureRequest {
    ...
    private com.singularbank.signature.routing.domain.model.valueobject.AbortReason abortReason;  // Story 2.12: Reason for abort
    ...
    public SignatureChallenge createChallenge(ChannelType channel, ProviderType provider) {
        ...
        SignatureChallenge challenge = SignatureChallenge.builder()
            ...
            .challengeCode(com.singularbank.signature.routing.domain.util.OtpGenerator.generate())
     ...
     * @throws com.singularbank.signature.routing.domain.exception.ChallengeNotFoundException if challenge not found
     */
    public SignatureChallenge findChallengeById(UUID challengeId) {
        return challenges.stream()
            .filter(c -> c.getId().equals(challengeId))
            .findFirst()
            .orElseThrow(() -> new com.singularbank.signature.routing.domain.exception.ChallengeNotFoundException(challengeId));
    }
     ...
     */
    public void abort(com.singularbank.signature.routing.domain.model.valueobject.AbortReason reason, String details) {
     ...
     */
    public void abortSignature(com.singularbank.signature.routing.domain.model.valueobject.AbortReason reason) {
        abort(reason, null);
    }
