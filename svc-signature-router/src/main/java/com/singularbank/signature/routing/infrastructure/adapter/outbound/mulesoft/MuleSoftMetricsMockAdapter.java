package com.singularbank.signature.routing.infrastructure.adapter.outbound.mulesoft;
 ...
 * - Cost: Based on typical provider pricing (SMS ~0.05â‚¬, PUSH ~0.01â‚¬)
 * 
...
public class MuleSoftMetricsMockAdapter implements MuleSoftMetricsPort {
    ...
    public MuleSoftMetricsMockAdapter() {
        log.warn("âš ï¸ USING MOCK MULESOFT METRICS ADAPTER - Not for production use!");
        log.warn("âš ï¸ Set mulesoft.metrics.enabled=true and configure real adapter for production");
    }
