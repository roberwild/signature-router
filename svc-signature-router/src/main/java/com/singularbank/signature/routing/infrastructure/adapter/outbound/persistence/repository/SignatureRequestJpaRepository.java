package com.singularbank.signature.routing.infrastructure.adapter.outbound.persistence.repository;
 ...
 * 
 * <p>
 * <b>Hexagonal Architecture Note:</b> This is an INFRASTRUCTURE component,
 * NOT exposed outside persistence package. Domain layer uses
 * SignatureRequestRepository
 * port interface, implemented by SignatureRequestRepositoryAdapter.
 * </p>
 * 
 * <p>
 * <b>Custom Queries:</b>
 * </p>
 * <ul>
 * <li>findByIdWithChallenges: Eager loading with @EntityGraph (avoid N+1
 * queries)</li>
...
public interface SignatureRequestJpaRepository extends JpaRepository<SignatureRequestEntity, UUID> {
     ...
     * 
     * <p>
     * <b>Performance:</b> Uses @EntityGraph to fetch challenges in single query,
     * avoiding N+1 problem when accessing lazy-loaded collection.
     * </p>
     * 
     ...
     * 
     * <p>
     * Results are implicitly ordered by creation date (database default).
     * </p>
     * 
     ...
     * 
     * <p>
     * <b>Use Case:</b> Background job to mark expired requests and trigger cleanup.
     * </p>
     * 
     * <p>
     * <b>Example:</b>
     ...
     * 
     * <p>
     * <b>Query Logic:</b> Finds signature requests that have challenges with:
     * </p>
     * <ul>
     ...
     * 
     * TODO: SignatureRequestEntity no tiene campo 'channel' - implementar cuando se
     * agregue
     * 
    ...
    // long countByChannelAndCreatedAtBetween(String channel, Instant from, Instant
    // to);
    ...
    /**
     * Find signature requests that have challenges with completedAt in the given
     * range.
    ...
    /**
     * Find signature requests that have challenges sent in the given range (for
     * total count).
     * 
    ...
    /**
     * Get channel success rates - count of successful vs total challenges per
     * channel.
