package com.singularbank.signature.routing.infrastructure.adapter.outbound.provider.stub;
...
public class StubSmsProvider implements SignatureProviderPort {
    ...
    @Override
    public HealthStatus checkHealth(com.singularbank.signature.routing.domain.model.valueobject.ProviderType providerType) {
