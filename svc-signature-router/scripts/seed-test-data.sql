...
(
    ...
    'CUST-001',
    'COMPLETED',
    '{"transactionId":"TXN-2024-001","amount":1500.50,"currency":"EUR","merchantName":"Amazon ES"}'::jsonb,
    '[{"timestamp":"2025-12-01T10:58:24Z","channel":"SMS","provider":"TWILIO_SMS","ruleName":"SMS Premium"}]'::jsonb,
...
(
    ...
    'CUST-002',
    'PENDING',
    '{"transactionId":"TXN-2024-002","amount":250.00,"currency":"EUR","merchantName":"Zara Online"}'::jsonb,
    '[{"timestamp":"2025-12-02T09:58:24Z","channel":"PUSH","provider":"FCM","ruleName":"PUSH - FCM"}]'::jsonb,
    NOW() - INTERVAL '1 hour',
    NOW() + INTERVAL '4 days 23 hours',
    NULL,
    NULL,
...
(
    ...
    'CUST-003',
    'COMPLETED',
    '{"transactionId":"TXN-2024-003","amount":89.99,"currency":"EUR","merchantName":"Netflix"}'::jsonb,
    '[{"timestamp":"2025-12-01T15:58:24Z","channel":"PUSH","provider":"FCM","ruleName":"PUSH - FCM"}]'::jsonb,
...
(
    ...
    'CUST-004',
    'EXPIRED',
    '{"transactionId":"TXN-2024-004","amount":3200.00,"currency":"EUR","merchantName":"MediaMarkt"}'::jsonb,
    '[{"timestamp":"2025-11-27T19:58:24Z","channel":"SMS","provider":"TWILIO_SMS","ruleName":"SMS Premium"}]'::jsonb,
...
(
    ...
    'CUST-005',
    'FAILED',
    '{"transactionId":"TXN-2024-005","amount":500.00,"currency":"EUR","merchantName":"Apple Store"}'::jsonb,
    '[{"timestamp":"2025-12-01T14:58:24Z","channel":"SMS","provider":"TWILIO_SMS","ruleName":"SMS Premium","error":"PROVIDER_TIMEOUT"}]'::jsonb,
...
(
    ...
    'CUST-006',
    'ABORTED',
    '{"transactionId":"TXN-2024-006","amount":1200.00,"currency":"EUR","merchantName":"El Corte Inglés"}'::jsonb,
    '[{"timestamp":"2025-11-30T21:58:24Z","channel":"VOICE","provider":"TWILIO_VOICE","ruleName":"VOICE - Twilio"}]'::jsonb,
...
(
    ...
    NOW() - INTERVAL '24 hours',
    NOW() + INTERVAL '4 days 23 hours',
    '{"messageSid":"SM_abc123","deliveryStatus":"delivered","deliveredAt":"2025-12-01T10:58:30Z"}'::jsonb,
    NULL
),
...
(
    ...
    NULL,
    NOW() + INTERVAL '4 days 23 hours',
    '{"messageId":"FCM_msg_456","notificationId":"notif_789"}'::jsonb,
    NULL
),
...
(
    ...
    NOW() - INTERVAL '16 hours 58 minutes',
    NOW() + INTERVAL '4 days 7 hours',
    '{"messageId":"FCM_msg_789","clickAction":"signature_confirm","openedAt":"2025-12-01T16:00:25Z"}'::jsonb,
    NULL
),
...
(
    ...
    NULL,
    NOW() - INTERVAL '4 hours',
    '{"messageSid":"SM_expired_111","deliveryStatus":"delivered"}'::jsonb,
    NULL
),
...
(
    ...
    NULL,
    NOW() + INTERVAL '2 days 22 hours',
    '{"callSid":"CA_voice123","callDuration":20,"hangupReason":"user_cancel"}'::jsonb,
    NULL
);
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_completed FROM signature_request WHERE status = 'COMPLETED';
