...
// Interface for parsed message from sessionStorage
...
interface ServicesChatbotFullPageProps {
...
export function ServicesChatbotFullPage({ 
  organizationId, 
  organizationSlug,
  organizationName,
  userId,
  ...
  useEffect(() => {
    ...
    const savedSessionId = sessionStorage.getItem('chatbot-session-id');
    
    if (savedMessages) {
      try {
        const parsedMessages = JSON.parse(savedMessages);
        setMessages(parsedMessages.map((msg: ParsedMessage) => ({
          ...msg,
