...
import { MoreHorizontalIcon, LanguagesIcon } from 'lucide-react';
...
import { useLanguageSwitcher, useTranslations } from '~/hooks/use-translations';
...
export function NavUser({
  ...
  const handleNavigateToProfilePage = (): void => {
    router.push(
      `/${locale}/organizations/${activeOrganization.slug}/settings/account/profile`
    );
  };
  const handleNavigateToBillingPage = (): void => {
    router.push(
      `/${locale}/organizations/${activeOrganization.slug}/settings/organization/billing`
    );
  };
            ...
            >
              ...
              <DropdownMenuGroup>
                ...
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent>
                    <DropdownMenuRadioGroup value={currentLocale} onValueChange={(value) => {
                      ...
                      <DropdownMenuRadioItem value="es">
                        {languages.es.flag} {languages.es.name}
                      </DropdownMenuRadioItem>
                    </DropdownMenuRadioGroup>
                  </DropdownMenuSubContent>
                </DropdownMenuSub>
