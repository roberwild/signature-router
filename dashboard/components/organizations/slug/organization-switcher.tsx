        ...
        <DropdownMenu onOpenChange={handleOpenChange}>
          ...
          >
            <div className="relative">
              ...
              <Input
                placeholder={t('organizationMenu.search')}
                value={searchTerm}
            ...
            {filteredOrganizations.length === 0 ? (
              <EmptyText className="p-2">{t('organizationMenu.noOrganizationFound')}</EmptyText>
            ) : (
            ...
            >
              ...
              >
                ...
                {t('organizationMenu.allOrganizations')}
              </Link>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem
            ...
            >
              ...
              >
                ...
                {t('organizationMenu.accountSettings')}
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem
              asChild
            ...
            >
              ...
              >
                ...
                {t('organizationMenu.organizationSettings')}
              </Link>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem
            ...
            >
              ...
              >
                ...
                {t('organizationMenu.addOrganization')}
              </Link>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
