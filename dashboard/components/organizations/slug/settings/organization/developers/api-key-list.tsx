  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        >
{apiKey.expiresAt
            ? t('developers.apiKeys.table.expires') + ` ${format(apiKey.expiresAt, 'dd MMM yyyy')}`
...
title={t('developers.apiKeys.actions.openMenu')}
          >
            <MoreHorizontalIcon className="size-4 shrink-0" />
            <span className="sr-only">{t('developers.apiKeys.actions.openMenu')}</span>
          </Button>
        </DropdownMenuTrigger>
        <DropdownMenuContent align="end">
          ...
          >
{t('developers.apiKeys.actions.edit')}
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem
          ...
          >
{t('developers.apiKeys.actions.revoke')}
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </li>
