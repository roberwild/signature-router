    ...
    >
      <div className="flex flex-col">
        ...
        {webhook.triggers.length > 0 ? (
          ...
          <p className="text-xs text-muted-foreground">{t('developers.webhooks.messages.noTriggers')}</p>
        )}
      </div>
...
title={t('developers.webhooks.actions.openMenu')}
          >
            <MoreHorizontalIcon className="size-4 shrink-0" />
            <span className="sr-only">{t('developers.webhooks.actions.openMenu')}</span>
          </Button>
        </DropdownMenuTrigger>
        <DropdownMenuContent align="end">
          ...
          >
{t('developers.webhooks.actions.edit')}
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem
          ...
          >
{t('developers.webhooks.actions.delete')}
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </li>
