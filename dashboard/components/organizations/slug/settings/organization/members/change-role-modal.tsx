...
export const ChangeRoleModal = NiceModal.create<ChangeRoleModalProps>(
  ({ profile, member }) => {
    ...
    const title = t('members.team.actions.changeRole');
    const description = t('members.team.messages.changeRoleDescription');
    const canSubmit =
    ...
    const onSubmit: SubmitHandler<ChangeRoleSchema> = async (values) => {
      ...
      if (!result?.serverError && !result?.validationErrors) {
        toast.success(t('members.team.messages.updateSuccess'));
        modal.handleClose();
      } else {
        toast.error(t('members.team.messages.updateError'));
      }
    };
    const renderForm = (
      <form
    ...
    const renderButtons = (
      <>
        ...
        >
          {t('members.team.actions.changeRole')}
        </Button>
      </>
    );
    return (
