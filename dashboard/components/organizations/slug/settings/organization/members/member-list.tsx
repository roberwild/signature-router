...
{t('members.team.roles.owner')}
        ...
        <Badge
          ...
          className="hidden rounded-3xl sm:inline-block"
        >
{t(`members.team.roles.${member.role.toLowerCase()}`)}
        </Badge>
...
{t('members.team.actions.changeRole')}
            ...
            >
              {t('members.team.messages.transferOwnership')}
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem
            ...
            >
              {profile.id === member.id
                ? t('members.team.messages.leaveOrganization')
                : t('members.team.actions.remove')}
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
