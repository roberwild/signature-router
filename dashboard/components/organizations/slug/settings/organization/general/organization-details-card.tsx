...
export function OrganizationDetailsCard({
  ...
  const onSubmit: SubmitHandler<UpdateOrganizationDetailsSchema> = async (
    ...
    if (!result?.serverError && !result?.validationErrors) {
      toast.success(t('general.organizationDetails.messages.updateSuccess'));
    } else {
      toast.error(t('general.organizationDetails.messages.updateError'));
    }
  };
  return (
    <FormProvider {...methods}>
      <Card {...props}>
        <CardContent className="pt-6">
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel required>{t('general.organizationDetails.fields.name')}</FormLabel>
                  <FormControl>
                    <Input
                      type="text"
                      maxLength={255}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.organizationDetails.fields.address')}</FormLabel>
                  <FormControl>
                    <Input
                      type="text"
                      maxLength={255}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.organizationDetails.fields.phone')}</FormLabel>
                  <FormControl>
                    <Input
                      type="tel"
                      maxLength={32}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.organizationDetails.fields.email')}</FormLabel>
                  <FormControl>
                    <Input
                      type="email"
                      maxLength={255}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.organizationDetails.fields.website')}</FormLabel>
                  <FormControl>
                    <Input
                      type="url"
                      maxLength={2000}
        ...
        <CardFooter className="flex w-full justify-end pt-6">
          ...
          >
{t('general.organizationDetails.actions.save')}
          </Button>
        </CardFooter>
      </Card>
    </FormProvider>
