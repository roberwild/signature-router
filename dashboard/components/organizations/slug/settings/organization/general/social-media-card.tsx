...
export function SocialMediaCard({
  ...
  const onSubmit: SubmitHandler<UpdateSocialMediaSchema> = async (values) => {
    ...
    if (!result?.serverError && !result?.validationErrors) {
      toast.success(t('general.socialMedia.messages.updateSuccess'));
    } else {
      toast.error(t('general.socialMedia.messages.updateError'));
    }
  };
  return (
    <FormProvider {...methods}>
      <Card {...other}>
        <CardContent className="p-6">
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.socialMedia.fields.linkedin')}</FormLabel>
                  <FormControl>
                    <InputWithAdornments
                      type="url"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.socialMedia.fields.instagram')}</FormLabel>
                  <FormControl>
                    <InputWithAdornments
                      type="url"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex w-full flex-col">
                  <FormLabel>{t('general.socialMedia.fields.youtube')}</FormLabel>
                  <FormControl>
                    <InputWithAdornments
                      type="url"
            ...
            {showMore && (
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex w-full flex-col">
                      <FormLabel>{t('general.socialMedia.fields.twitter')}</FormLabel>
                      <FormControl>
                        <InputWithAdornments
                          type="url"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex w-full flex-col">
                      <FormLabel>{t('general.socialMedia.fields.facebook')}</FormLabel>
                      <FormControl>
                        <InputWithAdornments
                          type="url"
            ...
            >
              {showMore ? t('general.socialMedia.actions.showLess', { defaultValue: 'Show less...' }) : t('general.socialMedia.actions.showMore', { defaultValue: 'Show more...' })}
            </Button>
          </form>
        </CardContent>
        <Separator />
        <CardFooter className="flex w-full justify-end pt-6">
          ...
          >
{t('general.socialMedia.actions.save')}
          </Button>
        </CardFooter>
      </Card>
    </FormProvider>
