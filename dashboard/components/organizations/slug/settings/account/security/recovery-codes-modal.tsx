...
export const RecoveryCodesModal = NiceModal.create<RecoveryCodesModalProps>(
  ({ recoveryCodes }) => {
    ...
    const title = t('security.multiFactorAuth.modal.recoveryCodes.title');
    const description = t('security.multiFactorAuth.modal.recoveryCodes.description');
    ...
    const renderButtons = (
      <>
        ...
        >
          {t('security.multiFactorAuth.modal.recoveryCodes.close')}
        </Button>
        <Button
          type="button"
          variant="outline"
        ...
        >
          {t('security.multiFactorAuth.modal.recoveryCodes.copy')}
        </Button>
        <Button
          type="button"
          variant="default"
        ...
        >
          {t('security.multiFactorAuth.modal.recoveryCodes.download')}
        </Button>
      </>
    );
    return (
