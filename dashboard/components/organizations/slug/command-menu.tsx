  ...
  const navigationGroups = [
    {
      ...
      items: createMainNavItems(activeOrganization.slug, locale)
    },
    {
      heading: 'Account',
      items: createAccountNavItems(activeOrganization.slug, locale)
    },
    {
      heading: 'Organization',
      items: createOrganizationNavItems(activeOrganization.slug, locale)
    }
  ];
  return (
    <CommandDialog
