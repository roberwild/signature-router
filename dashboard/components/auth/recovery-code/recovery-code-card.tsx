...
export function RecoveryCodeCard({
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle className="text-base lg:text-lg">{t('recoveryCode.title') || 'Enter recovery code'}</CardTitle>
        <CardDescription>
          {t('recoveryCode.description') || 'Enter one of your recovery codes to access your account.'}
        </CardDescription>
      </CardHeader>
      <CardContent>
                ...
                <div className="flex flex-row items-center gap-2">
                  ...
                  <AlertDescription>
                    ...
                    {errorCode === AuthErrorCode.RequestExpired && (
                      ...
                      >
                        {t('recoveryCode.signInAgain') || 'Sign in again'}
