    ...
    >
        ...
        <div className="relative">
          ...
          {image && (
            <Tooltip>
              ...
              <TooltipContent side="right">{t('steps.profile.fields.image.removeTooltip')}</TooltipContent>
            </Tooltip>
          )}
        </div>
      </div>
      <div className="grid gap-x-8 gap-y-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel required>{t('steps.profile.fields.name.label')}</FormLabel>
              <FormControl>
                <Input
                  type="text"
                  maxLength={64}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('steps.profile.fields.phone.label')}</FormLabel>
              <FormControl>
                <Input
                  type="tel"
                  maxLength={32}
        ...
        <div className="mb-2 flex flex-col space-y-2">
          <FormLabel required>{t('steps.profile.fields.email.label')}</FormLabel>
          <Input
            type="email"
            maxLength={255}
