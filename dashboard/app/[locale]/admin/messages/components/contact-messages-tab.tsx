...
export function ContactMessagesTab({ messages, stats: _stats, locale }: ContactMessagesTabProps) {
        ...
        <CardContent className="p-4">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-1 items-center gap-2">
              ...
              <Select value={statusFilter} onValueChange={(value) => setStatusFilter(value as 'all' | 'unread' | 'read' | 'archived')}>
                      ...
                      <div className="space-y-1">
                        ...
                        <div 
                          ...
                          dangerouslySetInnerHTML={{ 
                            __html: message.message.replace(/<[^>]*>/g, ' ').substring(0, 150) + '...' 
                          }}
                        />
                      </div>
                    </TableCell>
