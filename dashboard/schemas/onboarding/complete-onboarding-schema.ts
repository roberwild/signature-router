...
export const leadQualificationOnboardingSchema = z.object({
  responses: z.record(z.string(), z.any()).default({}), // Store all question responses
  currentQuestionIndex: z.number().min(0).default(0),
  completedRequired: z.boolean().default(false),
  skippedOptional: z.boolean().default(false),
  completionTime: z.number().optional(),
  timePerQuestion: z.record(z.string(), z.number()).optional(),
  questionsAnswered: z.number().optional(),
  optionalAnswered: z.number().optional(),
  textEngagementScore: z.number().optional(), // Score for free text engagement
  hasSpecificNeeds: z.boolean().optional() // Whether they wrote specific needs
});
...
export const completeOnboardingSchema = z.object({
  ...
  leadQualificationStep: leadQualificationOnboardingSchema.optional()
});
